...
\textsc{Abstract}
\end{center}
Deeper understanding of structure forming processes in the context of mesoscopic polymer systems is relevant for a number of technological and biomedical applications. In this thesis, we employ advanced generalized-ensemble Monte Carlo methods to perform extensive simulations of coarse-grained, off-lattice, polymer models. We systematically examine the effects of short-range repulsion and bond confinement on the structural macrostates and transitions of flexible elastic homopolymers. Using the tools of the microcanonical inflection-point analysis, we unravel the properties of the aggregation transition, and show that in finite polymer systems, aggregation is a first-order process consisting of a sequence of substransitions between intermediate structural phases.
...
I would like to extend my gratitude to Prof. Michael Bachmann. His mentorship was the most integral part of my wonderful learning adventure of the past four years. Our countless conversations about the many marvelous intricacies of physics and life had a profound impact on my academic and personal development. 

I thank Prof. Steven Lewis for the exciting and challenging introduction into the beautiful field of classical electrodynamics. His passion for teaching was one of the main factors that finally lead to my decision to pursue a doctorate in physics. I'm also deeply indebted to Prof. Bernd Sch\"{u}ttler for his time and endless patience, when 5 years ago, I showed up in his class on mathematical physics with no prior education in either math or physics. I thank Prof. David Landau for his dedication to provide excellent educational resources and opportunities to all CSP students. I would like to thank Jeff Deroshia and Mike Caplinger for keeping our computers in great shape and Shan-Ho Tsai for providing access to the GACRC computing resources.

Finally, I would like to extend my deepest gratitude to my wonderful family and friends that have supported me both financially and emotionally over the past years. In particular, I want to express my thanks to the Link family who have graciously accepted me as their son and whose support was instrumental to my success.
...
(a) The jump discontinuity in the canonical entropy $S$, (b) and the singularity in the specific heat $C_{V}$, are characteristic of first order phase transitions.}
\end{figure} 
...
\begin{equation}
\label{eq:approx1}
\beta(E) \approx \beta_{c}(\bar{E}_{p,E}),
\end{equation}
and
\begin{equation}
\label{eq:approx2}
