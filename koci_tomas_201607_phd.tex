...
Two complementary classes of computational algorithms have been particularly successful. In molecular dynamics simulations, the positions and momenta of every particle in a system are updated according to Hamilton's equations, to generate a single phase space trajectory. On the other hand, Monte Carlo simulations perform stochastic sampling of the phase space to extract equilibrium properties, without an explicit consideration for the system's dynamics. In this chapter, we shall focus our attention on Markov chain Monte Carlo methods. We will briefly discuss the essential theory and introduce the well established Metropolis and Parallel Tempering methods as well as the lesser known Multiple Gaussian modified ensemble method.



\section{Markov chain Monte Carlo}
The underlying theory behind Monte Carlo simulations is that of Markov chains.
