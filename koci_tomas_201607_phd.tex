...
(-1)^{m}\mathrm{Y}_{l}^{m}(\mathbf{r}_{i})\right] & \quad \mathrm{if} \quad  m > 0. \\
	...
	\right. 
\end{equation}
} evaluated at positions of the individual monomers \cite{Neirotti2000}. This approach has been particularly effective in the investigations of polymer systems exhibiting multiple solid pseudophases at low energies \cite{Koci2016}.
