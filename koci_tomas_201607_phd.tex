...
\end{equation}
%
In addition to the FENE potential [Eq. \ref{eq:FENE}], the bonded interactions contain an additional Lennard-Jones term which makes the resultant potential asymmetric
%
\begin{equation}
U_{\mathrm{bonded}}(r_{ii+1})= U_{\mathrm{FENE}}(r_{ii+1}) +  U_{\mathrm{LJ}}^{\mathrm{trunc}}(r_{ii+1}).
\end{equation}
%
The shapes of the bonded and non-bonded potentials are depicted in Fig. \ref{fig:potentials}. 
